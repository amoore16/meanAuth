...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Authentication App</h1>\n  <p class=\"lead\">This is a MEAN Auth application built from scratch. It can be used as a template and is versitle and scalable. It will be hosted on Heroku at some point</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\" style=\"margin: 5px;\">Register</a>\n    <a class=\"btn btn-secondary\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose to organize models and query the database</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to generate components, services and more. Local dev server and easy compilation</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n  </div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessageService.show('Login Success', { cssClass: 'alert-success', timeout: 3000 });
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('Registration Success', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('Registration Failed', { cssClass: 'alert-danger', timeout: 3000 });
...
module.exports = __webpack_require__(/*! /home/alex/Documents/Projects/meanAuth/angular-src/src/main.ts */"./src/main.ts");
